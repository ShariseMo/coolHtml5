		...
		<table class="upload_table" border="1">
				...
				<tr>
					<td rowspan="3" class="temp_pic_box">
						<img src="/images/client_background/adv_templ_video.png" class="template_pic" alt="">
						<h2>视频为主模板</h2>
					...
					<td class="second_td">
					<p>位置一(视频)</p>
					<input type="file" id="file_1" multiple id="file_3" multiple @change="add_video">
				...
				<tr>
					<td class="second_td">
					<p>位置二(产品图)</p>
					<input type="file" id="file_2" multiple @change="add_pic">
